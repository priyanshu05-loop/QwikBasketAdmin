...
// --- UPDATED & ROBUST TYPOGRAPHY ---
// Font sizes are now calculated dynamically using RFValue for true responsiveness.
// This new structure is simpler and eliminates the nested 'fontSize' object.
export const typography = {
  // titleBold: {
  //   fontFamily: 'Poppins-SemiBold',
  //   fontWeight: '600',
  //   fontSize: RFValue(18, height), // Base size 22, scales with screen height
  // },
  // paragraphRegular: {
  //   fontFamily: 'Poppins-Regular',
  //   fontWeight: '400',
  //   fontSize: RFValue(14, height), // Base size 14
  // },
  // paragraphMedium: {
  ...
  //   fontFamily: 'Poppins-Medium',
  //   fontWeight: '500',
  //   fontSize: RFValue(12, height), // Base size 12
  // },
  // button :{
  //   fontFamily: 'Poppins-Medium',
  //   fontWeight: '700',
  //   fontSize: RFValue(14, height), // Base size 12
  // },
  ...
  //   fontFamily: 'Poppins-Medium',
  //   fontWeight: '500',
  //   fontSize: RFValue(7, height), // Base size 14
  // },
  //  titleBold1: {
  //   fontFamily: 'Poppins-SemiBold',
  //   fontWeight: '600',
  //   fontSize: RFValue(8, height), // Base size 22, scales with screen height
  // },
  // paragraphRegular1: {
  //   fontFamily: 'Poppins-Regular',
  //   fontWeight: '400',
  //   fontSize: RFValue(8, height), // Base size 14
  // },
  //  label1: {
  //   fontFamily: 'Poppins-Medium',
  //   fontWeight: '500',
